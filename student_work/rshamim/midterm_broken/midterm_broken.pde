...
//how do you play around with posPercentage? convert from float to boolean
//assign an instance to circle1
 if (circle1 != null){
    circle1.update();
    circle1.render();
  }
}
//when posPercentage ---?, we create a new instance of a CircleObject. 
 // create function when beat detecter isOnset.  i'm trying to create a circle object
void posPercentage(){
  circle1 = new CircleObject(posx, 250, 5, color(125,64,254));
