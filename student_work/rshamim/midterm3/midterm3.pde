...
float y;
//import sound library audio analysis to play with frequency spectrum
...
void draw()
{
  ...
  pushMatrix();
    ...
    for(int i = 0; i < player.bufferSize() - 1; i++)
    {
      ...
      float x1 = map( i, 0, player.bufferSize(), -width/2, width/2 );
      ...
      stroke (199,0,57);
      circle (x1, 0, 10 + player.right.get(i)*50);
